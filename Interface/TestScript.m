...
for i = 1:transducer_number
    ...
    for fi = 1:size(f,2)
        for aj = 1:size(a,2)
            switch i
                case 1
                    BTcall(0,1,2,2,object);
                case 2
                    BTcall(0,2,1,2,object);
                case 3
                    BTcall(0,2,2,1,object);
            end       
            % Turn on
            try
            ...
            % FG & AMP write
            BTcall(channel(i),a(aj),f(fi),0,object);
            pause(stimtime);
            ...
            switch i
                case 1
                    BTcall(0,0,2,2,object);
                case 2
                    BTcall(0,2,0,2,object);
                case 3
                    BTcall(0,2,2,0,object);
            end 
